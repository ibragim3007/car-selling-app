  ...
  return (
    <ScrollViewPage spaceVertical="sm">
      <CardTitle title={'Пожалуйста, прочтите внимательно '} borderRadius={16}>
        ...
        <Typography variant="subhead">
          {'\u25CF '}
          <Typography weight="bold">Сервисы и подписки: </Typography>Если вы используете подписки или связанные сервисы,
          они также будут отменены. Это может включать доступ к специализированным функциям или контенту, который больше
          не будет доступен.
        </Typography>
